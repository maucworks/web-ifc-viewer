...
Allow loading of local `.ifc` files, or URL to `.ifc` file. For instance the 'raw' download link to a github hosted ifc file can be pasted, see the live link below.
